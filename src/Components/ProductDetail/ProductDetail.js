...
class ProductDetail extends React.Component {
	...
	displayButton = () => {
		...
		if (this.state.item.instock) {
			return (
				<Popup trigger={<button className="button">Buy Now</button>} modal>
					<Checkout product={this.state.item} classes={classes} />
				</Popup>
				);
		} else if (!this.state.isNotified) {
